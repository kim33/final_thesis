...
out_path = "detoxified/qwen/qen2_7B_paradetox_detoxified_0731.json"
os.makedirs(os.path.dirname(out_path), exist_ok=True)

refusal_log = "detoxified/qwen/qwen2_7B_paradetox_refused_samples_0731.json"
os.makedirs(os.path.dirname(refusal_log), exist_ok=True)

fail_log = "detoxified/qwen/qwen2_7B_failed_samples_paradetox_0731.json"
