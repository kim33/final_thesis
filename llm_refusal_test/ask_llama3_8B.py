...
# Load dataset
with open("dataset/paradetox_extract.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
out_path = "detoxified/llama3/llama3_8B_paradetox_detoxified_0731.json"
os.makedirs(os.path.dirname(out_path), exist_ok=True)

fail_log = "detoxified/llama3/failed_samples_paradetox_llama3_8B__0731.json"
os.makedirs(os.path.dirname(fail_log), exist_ok=True)

refusal_log = "detoxified/llama3/refused_samples_paradetox_llama3_8B_0731.json"
