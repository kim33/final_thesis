...
OUTOUT_PATH = "false_refusal_categorize/llama/bert/llama_70B_davidson_bert_bias.json"
FAILED_PATH =  "false_refusal_categorize/llama/bert/llama_70B_davidson_bert_bias_failed.json"
BATCH_SIZE = 32
SAVE_EVERY = 30
DETOX = "original"   
