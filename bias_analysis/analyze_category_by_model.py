...
FILES = [
   "bias_analysis/mistral/mistral_7B_davidson.csv",
   "bias_analysis/mistral/mistral_7B_hatexplain.csv",
   "bias_analysis/mistral/mistral_7B_paradetox.csv"
]
OUTPUT = "bias_analysis/mistral/mistral_7B"
