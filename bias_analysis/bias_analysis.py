...
RAW_PATH = "dataset/holistic/paradetox_holistic_bias_summary.json"
REFUSED_PATH = "false_refusal_categorize/gemma/gemma_8B/gemma3_8B_holistic_bias_paradetox_summary.json"
OUTPUT = "bias_analysis/gemma/gemma3_8B_paradetox.csv"
MODEL="Gemma3 8B"
DATASET="paradetox"
IMAGE_OUTPUT=f"bias_analysis/gemma/{MODEL}_{DATASET}.png"
